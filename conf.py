...
project = 'Програмирање за 8. разред'
...
html_context = {'course_id': 'Програмирање за 8. разред',
                ...
                'basecourse': 'Програмирање за 8. разред',
...
html_theme_options = {
    ...
    'navbar_title': "Програмирање за 8. разред",
...
html_title = 'Програмирање за 8. разред'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Програмирање за 8. разред'
...
htmlhelp_basename = 'Programiranje8-doc'
