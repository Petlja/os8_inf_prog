...
project = 'Анализа и презентација података у Џупитеру за осми разред'
#pylint: disable=redefined-builtin
copyright = '2022 Lazar'
...
html_context = {'course_id': 'Osmi_programiranje',
...
html_theme_options = {
    ...
    'navbar_title': "Анализа и презентација података у Џупитеру за осми разред",
...
html_title = 'Анализа и презентација података у Џупитеру за осми разред'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Анализа и презентација података у Џупитеру за осми разред'
...
htmlhelp_basename = 'Osmi_programiranje-doc'
