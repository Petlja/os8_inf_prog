...
корак са којим вредности мењају.
...
примера како пример са *for* петљом можемо да напишемо користећи
инструкцију ``while``.
...
инструкција, иде оно што треба извршти ако је услов испуњен, тј. да
...
пријављује грешку ако блокови нису правилно увучени. Ево примера како
