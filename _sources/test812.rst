...
.. mchoice:: Тест12_Питање4
   ...
   :answer_d: Овај програм снима учитане податке на рачунар на коме се програм извршава у формату CSV и при томе у датотеку не записује садржај индексне колоне.:answer_d: 
   :correct: d
