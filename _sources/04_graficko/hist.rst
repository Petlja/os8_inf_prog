...
Хистограм је графички приказ расподеле бројачаних података у одређеном
...
пребројавања прикаже као стубични дијаграм по тим интервалима.
...
Иако хистограм изгледа као стубични дијаграм, постоје разлике. Док се
стубични дијаграм приказује за низ бројева на *x*-оси, код хистограма се
